...
bronze_fracs_hist2 <- ggplot(time_fracs[bronze_fracs,], aes(x = ScoutTime)) +
                geom_histogram(aes(y=(..count..)/(bronze_uids*2)), color=bronze_col, fill=bronze_col,
