...
bronze_fracs_hist2 <- ggplot(time_fracs[bronze_fracs,], aes(x = ScoutTime)) +
                geom_histogram(aes(y=(..count..)/(bronze_uids*2)), color="#4d4dff", fill="#4d4dff",
                bins = 30, alpha = 0.4) + labs(y="% of Matches", x = "Gametime-Bronze") + 
...
silver_fracs_hist2 <- ggplot(time_fracs[silver_fracs,], aes(x = ScoutTime)) +
                geom_histogram(aes(y=(..count..)/(silver_uids*2)),color="#36b3b3",fill="#36b3b3",
                bins = 30, alpha = 0.4)+ labs(y = " ", x = "Gametime-Silver") + 
                coord_cartesian(ylim = c(0, 1))+ scale_y_continuous(labels=scales::percent) +
                scale_x_continuous(labels = scales::percent)
gold_fracs_hist2 <- ggplot(time_fracs[gold_fracs,], aes(x = ScoutTime)) +
                geom_histogram(aes(y=(..count..)/(gold_uids*2)),color="#884dff",fill="#884dff",
                bins = 30, alpha = 0.4)+ labs(y = " ", x = "% of Gametime-Gold") + 
                coord_cartesian(ylim = c(0, 1))+ scale_y_continuous(labels=scales::percent) +
                scale_x_continuous(labels = scales::percent)
plat_fracs_hist2 <- ggplot(time_fracs[plat_fracs,], aes(x = ScoutTime)) +
                geom_histogram(aes(y=(..count..)/(plat_uids*2)),color="#00e5e6",fill="#00e5e6",
                bins = 30, alpha = 0.4)+labs(y="% of Matches", x = "Gametime-Platinum") + 
                coord_cartesian(ylim = c(0, 1))+ scale_y_continuous(labels=scales::percent) +
                scale_x_continuous(labels = scales::percent)
diam_fracs_hist2 <- ggplot(time_fracs[diam_fracs,], aes(x = ScoutTime)) +
                geom_histogram(aes(y=(..count..)/(diam_uids*2)),color="#3655b3",fill="#3655b3",
                bins = 30, alpha = 0.4)+ labs(y = " ", x = "Gametime-Diamond") + 
                coord_cartesian(ylim = c(0, 1))+ scale_y_continuous(labels=scales::percent) +
                scale_x_continuous(labels = scales::percent)
mast_fracs_hist2 <- ggplot(time_fracs[master_fracs,], aes(x = ScoutTime)) +
                geom_histogram(aes(y=(..count..)/(mast_uids*2)),color="#000066",fill="#000066",
                bins = 30, alpha = 0.4)+ labs(y=" ", x = "Gametime-Master") + 
                coord_cartesian(ylim = c(0, 1))+ scale_y_continuous(labels=scales::percent) +
                scale_x_continuous(labels = scales::percent)
gmaster_fracs_hist2 <- ggplot(time_fracs[gmaster_fracs,], aes(x = ScoutTime)) +
                geom_histogram(aes(y=(..count..)/(gmast_uids*2)),color="#3c00b3",fill="#3c00b3",
                bins = 30, alpha = 0.4)+labs(y = "% of Matches", x="Gametime-Grandmaster") +
                coord_cartesian(ylim = c(0, 1))+ scale_y_continuous(labels=scales::percent) +
                scale_x_continuous(labels = scales::percent)
...
novice_fracs_hist2 <- ggplot(time_fracs[novice_fracs,], aes(x = ScoutTime)) +
                geom_histogram(aes(y=(..count..)/(novice_uids*2)), color="#4d4dff", fill="#4d4dff",
                bins = 30, alpha = 0.4) + labs(y="% of Matches", x = "Gametime-Novice") + 
                coord_cartesian(ylim =c(0, 1))+ scale_y_continuous(labels=scales::percent) +
                scale_x_continuous(labels = scales::percent)
prof_fracs_hist2 <- ggplot(time_fracs[prof_fracs,], aes(x = ScoutTime)) +
                geom_histogram(aes(y=(..count..)/(prof_uids*2)),color="#36b3b3",fill="#36b3b3",
                bins = 30, alpha = 0.4)+ labs(y = " ", x = "Gametime-Proficient") + 
                coord_cartesian(ylim = c(0, 1))+ scale_y_continuous(labels=scales::percent) +
                scale_x_continuous(labels = scales::percent)
expert_fracs_hist2 <- ggplot(time_fracs[expert_fracs,], aes(x = ScoutTime)) +
                geom_histogram(aes(y=(..count..)/(expert_uids*2)),color="#884dff",fill="#884dff",
                bins = 30, alpha = 0.4)+ labs(y = " ", x = "Gametime-Expert") + 
                coord_cartesian(ylim = c(0, 1))+ scale_y_continuous(labels=scales::percent) +
                scale_x_continuous(labels = scales::percent)
...
diam_frames_hist <- ggplot(time_frames1[diam_frames,], aes(x = ScoutTime)) +
                geom_histogram(aes(y=(..count..)/length(diam_frames)),color="#3655b3",fill="#3655b3",
                bins = 20, binwidth = 4000, alpha = 0.4)+ labs(y = " ", x = "Frames-Diamond") + 
                coord_cartesian(ylim = c(0, 0.4), xlim = c(0, 65000))+
                scale_y_continuous(labels=scales::percent)

mast_frames_hist <- ggplot(time_frames1[master_frames,], aes(x = ScoutTime)) +
                geom_histogram(aes(y=(..count..)/length(master_frames)),color="#000066",fill="#000066",
...
gmaster_frames_hist <- ggplot(time_frames1[gmaster_frames,], aes(x = ScoutTime)) +
              geom_histogram(aes(y=(..count..)/length(gmaster_frames)),color="#3c00b3",fill="#3c00b3",
...
novice_frames_hist <- ggplot(time_frames1[novice_frames,], aes(x = ScoutTime)) +
              geom_histogram(aes(y=(..count..)/length(novice_frames)), color="#4d4dff", fill="#4d4dff",
...
prof_frames_hist <- ggplot(time_frames1[prof_frames,], aes(x = ScoutTime)) +
                geom_histogram(aes(y=(..count..)/length(prof_frames)), color="#36b3b3", fill="#36b3b3",
...
expert_frames_hist <- ggplot(time_frames1[expert_frames,], aes(x = ScoutTime)) +
              geom_histogram(aes(y=(..count..)/length(expert_frames)), color="#884dff", fill="#884dff",
...
novice_frames_hist2 <- ggplot(time_frames1[novice_frames,], aes(x = ScoutTime)) +
                geom_histogram(aes(y=(..count..)/(novice_uids*2)), color="#4d4dff", fill="#4d4dff",
                binwidth = 600, alpha = 0.4) + labs(y="% of Matches", x = "Frames-Novice") + 
                coord_cartesian(ylim =c(0, 1), xlim = c(0, 65000))+
                scale_y_continuous(labels=scales::percent)
prof_frames_hist2 <- ggplot(time_frames1[prof_frames,], aes(x = ScoutTime)) +
                geom_histogram(aes(y=(..count..)/(prof_uids*2)), color="#36b3b3", fill="#36b3b3",
                binwidth = 600, alpha = 0.4) + labs(y=" ", x = "Frames-Proficient") + 
                coord_cartesian(ylim =c(0, 1), xlim = c(0, 65000))+
                scale_y_continuous(labels=scales::percent)
expert_frames_hist2 <- ggplot(time_frames1[expert_frames,], aes(x = ScoutTime)) +
                geom_histogram(aes(y=(..count..)/(expert_uids*2)), color="#884dff", fill="#884dff",
                binwidth = 600, alpha = 0.4) + labs(y=" ", x = "Frames-Expert") + 
                coord_cartesian(ylim =c(0, 1), xlim = c(0, 65000))+
                scale_y_continuous(labels=scales::percent)
