...
class Replay(Resource):
    ...
    def register_default_datapacks(self):
        ...
        self.register_datapack(
            ...
            lambda r: r.expansion == "LotV" and 70154 <= r.build < 72282,
        )
        self.register_datapack(
            datapacks["LotV"]["72282"],
            lambda r: r.expansion == "LotV" and 72282 <= r.build < 73620,
        )
        self.register_datapack(
            datapacks["LotV"]["73620"],
            lambda r: r.expansion == "LotV" and 73620 <= r.build < 76114,
        )
        self.register_datapack(
        ...
        self.register_datapack(
            ...
            lambda r: r.expansion == "LotV" and 77379 <= r.build < 78285,
        )
        self.register_datapack(
            datapacks["LotV"]["78285"],
            lambda r: r.expansion == "LotV" and 78285 <= r.build,
        )
